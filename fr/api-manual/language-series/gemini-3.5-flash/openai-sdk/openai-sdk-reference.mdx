---
title: "Gemini 3.5 Flash - OpenAI SDK - Référence Complète"
openapi: '/fr/api-manual/language-series/gemini-3.5-flash/openai-sdk/openai-sdk-reference.json POST /v1/chat/completions'
---
