---
title: "API tous modèles Gemini - format compatible OpenAI"
openapi: '/fr/api-manual/language-series/gemini/openai-sdk/openai-sdk-reference.json POST /v1/chat/completions'
---
