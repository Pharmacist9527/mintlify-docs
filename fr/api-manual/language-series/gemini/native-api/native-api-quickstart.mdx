---
title: "API tous modèles Gemini - Démarrage rapide API native"
openapi: '/fr/api-manual/language-series/gemini/native-api/native-api-quickstart.json POST /v1beta/models/{model}:generateContent'
---
