---
title: "API tous modèles Grok - Démarrage rapide Responses"
openapi: '/fr/api-manual/language-series/grok/responses/responses-quickstart.json POST /v1/responses'
---
