---
title: "API tous modèles Grok - Démarrage rapide Chat Completions"
openapi: '/fr/api-manual/language-series/grok/chat-completions/chat-completions-quickstart.json POST /v1/chat/completions'
---
