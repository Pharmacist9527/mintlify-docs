---
title: "Gemini 3.5 Flash Lite - API Native - Référence Complète"
openapi: '/fr/api-manual/language-series/gemini-3.5-flash-lite/native-api/native-api-reference.json POST /v1beta/models/gemini-3.5-flash-lite:generateContent'
---
