---
title: "Gemini 3.6 Flash - API Native - Démarrage Rapide"
openapi: '/fr/api-manual/language-series/gemini-3.6-flash/native-api/native-api-quickstart.json POST /v1beta/models/gemini-3.6-flash:generateContent'
---
