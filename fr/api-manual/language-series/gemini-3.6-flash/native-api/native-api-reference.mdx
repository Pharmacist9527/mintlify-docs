---
title: "Gemini 3.6 Flash - API Native - Référence Complète"
openapi: '/fr/api-manual/language-series/gemini-3.6-flash/native-api/native-api-reference.json POST /v1beta/models/gemini-3.6-flash:generateContent'
---
