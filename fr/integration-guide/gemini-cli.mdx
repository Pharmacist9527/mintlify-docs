...
**Important :** La configuration de Gemini CLI est **légèrement plus complexe** que celle d'autres outils, nécessitant la modification de fichiers d'installation. Si vous débutez en programmation, envisagez d'utiliser d'abord **Claude CLI** ou **Codex CLI** (configuration plus simple).
