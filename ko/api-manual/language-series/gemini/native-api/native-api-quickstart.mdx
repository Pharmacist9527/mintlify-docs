---
title: "Gemini 전체 모델 인터페이스 - Native API 빠른 시작"
openapi: '/ko/api-manual/language-series/gemini/native-api/native-api-quickstart.json POST /v1beta/models/{model}:generateContent'
---
