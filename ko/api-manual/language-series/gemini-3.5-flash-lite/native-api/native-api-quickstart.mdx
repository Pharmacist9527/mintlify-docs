---
title: "Gemini 3.5 Flash Lite - Native API - 빠른 시작"
openapi: '/ko/api-manual/language-series/gemini-3.5-flash-lite/native-api/native-api-quickstart.json POST /v1beta/models/gemini-3.5-flash-lite:generateContent'
---
