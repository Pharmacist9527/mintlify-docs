---
title: "Gemini Schnittstelle für alle Modelle - Schnellstart natives API"
openapi: '/de/api-manual/language-series/gemini/native-api/native-api-quickstart.json POST /v1beta/models/{model}:generateContent'
---
