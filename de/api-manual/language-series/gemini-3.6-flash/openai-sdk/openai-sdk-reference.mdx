---
title: "Gemini 3.6 Flash - OpenAI SDK - Vollständige Referenz"
openapi: '/de/api-manual/language-series/gemini-3.6-flash/openai-sdk/openai-sdk-reference.json POST /v1/chat/completions'
---
