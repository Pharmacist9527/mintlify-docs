---
title: "Gemini 3.5 Flash Lite - OpenAI SDK - Vollständige Referenz"
openapi: '/de/api-manual/language-series/gemini-3.5-flash-lite/openai-sdk/openai-sdk-reference.json POST /v1/chat/completions'
---
