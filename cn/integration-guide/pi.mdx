...
{/* TODO: 补 Pi TUI 界面总览截图 → /images/integration-guide/pi/pi-overview.png */}
...
{/* TODO: 补 Pi 会话内 /model 选择器截图（展示 evolink 供应商下的模型列表）→ /images/integration-guide/pi/pi-model-select.png */}
