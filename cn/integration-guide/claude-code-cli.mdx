...
<Tabs>
  ...
  <Tab title="方法四：使用 CC Switch（图形界面）">
    ...
    <Tabs>
      <Tab title="Windows">
        从 [GitHub Releases](https://github.com/farion1231/cc-switch/releases) 下载 `.msi` 安装包并运行。
      </Tab>
      <Tab title="macOS">
        **方式 1: Homebrew**
        ```bash
        ...
        **方式 2:** 从 [GitHub Releases](https://github.com/farion1231/cc-switch/releases) 下载 `.dmg` 文件并安装。
      </Tab>
      <Tab title="Linux">
        从 [GitHub Releases](https://github.com/farion1231/cc-switch/releases) 下载 `.deb` 或 `.rpm` 包并安装。
      </Tab>
    </Tabs>
    ...
    1. 打开 CC Switch
    2. 在提供商列表中选择 **EvoLink** 预设
    3. 填入你的 EvoLink API Key
    4. 点击"应用配置"
