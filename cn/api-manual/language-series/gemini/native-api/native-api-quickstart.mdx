---
title: "Gemini 全模型接口 - 原生 API 快速开始"
openapi: '/cn/api-manual/language-series/gemini/native-api/native-api-quickstart.json POST /v1beta/models/{model}:generateContent'
---
