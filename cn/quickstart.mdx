---
title: "快速接入"
description: "30秒体验企业级AI服务，释放无限创造力"
icon: "bolt"
---
...
<Steps>
  <Step title="注册账户">
    访问 [EvoLink控制台](https://evolink.ai/dashboard) 完成注册
  </Step>
  <Step title="创建密钥">
    进入API管理页面，点击"新建密钥"
  </Step>
...
<CardGroup cols={3}>
  ...
  <Card title="API文档" icon="book" href="cn/api-manual/image-series/gpt-4o-image-generation">
    查看详细的接口文档
  </Card>
