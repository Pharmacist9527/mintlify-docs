---
title: "Gemini 全モデルインターフェース - ネイティブ API クイックスタート"
openapi: '/ja/api-manual/language-series/gemini/native-api/native-api-quickstart.json POST /v1beta/models/{model}:generateContent'
---
