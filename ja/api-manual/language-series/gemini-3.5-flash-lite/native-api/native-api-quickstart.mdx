---
title: "Gemini 3.5 Flash Lite - Native API - クイックスタート"
openapi: '/ja/api-manual/language-series/gemini-3.5-flash-lite/native-api/native-api-quickstart.json POST /v1beta/models/gemini-3.5-flash-lite:generateContent'
---
