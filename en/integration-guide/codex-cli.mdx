  ...
  <Tab title="Method 1: GUI Operation">
    ...
    <Tabs>
      <Tab title="Windows">
        ...
        %userprofile%\.codex
        ```
        ![Windows Win+R open config directory](/images/integration-guide/codex-winr-demo-cn.png)
    ...
    ![Codex CLI config environment](/images/integration-guide/codex-config-env.png)
    ### 2. Edit config.toml
