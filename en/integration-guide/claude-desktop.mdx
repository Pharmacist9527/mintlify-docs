...
<Tabs>
  ...
  <Tab title="Windows">
    ...
    **Tip:** If you do not see the Developer entry, confirm that your Claude Desktop version supports Developer Mode and third-party inference settings.
    ...
    <Frame>
    ![Claude Desktop Windows Enable Developer Mode](/images/integration-guide/claude-desktop-windows-enable-developer-mode.png)
    </Frame>

    <Frame>
    ![Claude Desktop Windows Developer Menu](/images/integration-guide/claude-desktop-windows-configure-third-party-inference.png)
    </Frame>
  </Tab>
</Tabs>
