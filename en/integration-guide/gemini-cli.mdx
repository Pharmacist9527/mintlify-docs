...
**Important:** Gemini CLI configuration is **slightly more complex** than other tools, requiring modification of installation files. If you're new to programming, consider using **Claude CLI** or **Codex CLI** first (simpler configuration).
