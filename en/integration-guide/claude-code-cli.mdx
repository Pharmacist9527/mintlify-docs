  ...
  <Tab title="Windows">
    ...
    **Permanent configuration (Recommended):**
    1. Open **System Settings** → **System** → **About** → **Advanced system settings**
       ...
       ![Advanced system settings location](/images/integration-guide/en高级系统设置位置.png)

    2. Click **Environment Variables**

       ![Environment Variables location](/images/integration-guide/en环境变量位置.png)
    ...
    4. Click **New**, add the following path (note: it's the directory, not the exe file):
       ...
       ![Environment Variables configuration](/images/integration-guide/en环境变量.png)
