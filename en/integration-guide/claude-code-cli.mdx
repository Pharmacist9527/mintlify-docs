...
<Tabs>
  ...
  <Tab title="Method 2: Using CC Switch (GUI)">
    ...
    <Frame>
    ![CC Switch Open Configuration](/images/integration-guide/cc-switch/cc-switch-install.png)
    </Frame>
    3. Fill in the fields as shown in the image
    <Frame>
    ![CC Switch Configure EvoLink](/images/integration-guide/cc-switch/cc-switch-config-en.png)
    </Frame>
    4. Click "Add"
  ...
  <Tab title="Method 4: Temporary Setup (Current Terminal Only)">
    <Tabs>
      <Tab title="Windows">
        In PowerShell:
        ```powershell
