---
title: "Gemini 3.6 Flash - Native API - Full Reference"
openapi: '/en/api-manual/language-series/gemini-3.6-flash/native-api/native-api-reference.json POST /v1beta/models/gemini-3.6-flash:generateContent'
---
