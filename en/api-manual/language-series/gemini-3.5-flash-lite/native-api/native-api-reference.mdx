---
title: "Gemini 3.5 Flash Lite - Native API - Full Reference"
openapi: '/en/api-manual/language-series/gemini-3.5-flash-lite/native-api/native-api-reference.json POST /v1beta/models/gemini-3.5-flash-lite:generateContent'
---
