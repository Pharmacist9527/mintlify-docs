---
title: "Gemini 3.1 Pro Customtools - Native API - Full Reference"
openapi: '/en/api-manual/language-series/gemini-3.1-pro-preview-customtools/native-api/native-api-reference.json POST /v1beta/models/gemini-3.1-pro-preview-customtools:generateContent'
---
