...
Sets the render detail level. Range 1 - 4, default 1. Higher values produce richer detail and take longer to render. The flag is passed through to the upstream as-is and **does not change the price**.

```
a cat --q 3
```

- V8.2 accepts `1` / `2` / `3` / `4`; V8.1 accepts only `1` / `4`
