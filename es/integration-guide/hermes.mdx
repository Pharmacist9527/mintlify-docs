...
<Tabs>
  ...
  <Tab title="Windows">
    Ejecuta el comando de instalación rápida en **PowerShell**:

    ```powershell
    iex (irm https://hermes-agent.nousresearch.com/install.ps1)
    ```

    **Resultado esperado:** Verás información de descarga e instalación y, al final, un mensaje de instalación correcta.

    **Si ocurre un error:** Si se indica una restricción de la política de ejecución, abre PowerShell como administrador, o ejecuta primero `Set-ExecutionPolicy -Scope CurrentUser RemoteSigned` y vuelve a intentarlo.

    Tras la instalación, al ejecutar `hermes` por primera vez también se iniciará el asistente de instalación **Quick / Full**; los pasos para integrar EvoLink son idénticos a los de la pestaña macOS / Linux (se recomienda elegir **Full setup** e introducir en el asistente la dirección de la interfaz y la Key de EvoLink).
