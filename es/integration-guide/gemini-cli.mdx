...
**Importante:** La configuración de Gemini CLI es **ligeramente más compleja** que otras herramientas, ya que requiere modificar archivos de instalación. Si eres nuevo en programación, considera usar **Claude CLI** o **Codex CLI** primero (configuración más sencilla).
