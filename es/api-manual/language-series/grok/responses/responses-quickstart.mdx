---
title: "Interfaz de todos los modelos Grok - Inicio rápido de Responses"
openapi: '/es/api-manual/language-series/grok/responses/responses-quickstart.json POST /v1/responses'
---
