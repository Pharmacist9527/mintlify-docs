---
title: "Gemini 3.5 Flash - Native API - Referencia completa"
openapi: '/es/api-manual/language-series/gemini-3.5-flash/native-api/native-api-reference.json POST /v1beta/models/gemini-3.5-flash:generateContent'
---
